...
module.exports = {
    ...
    // Message from friend
        ...
        if (msg.length == 0)
            ui.emit('isTyping', steamID, user, getUserState(steamID));
        else
            ui.emit('message', steamID, user, getUserState(steamID), msg);
    },
    ...
    // Message in group chat
        ...
        ui.emit('groupMessage', chatID, user, getUserState(steamID), msg);
    },
    ...
    // Something happened in group chat/clan.
        ...
        ui.emit('activity', chatID, stateChange, getUserName(steamID), getUserName(actorID));
