...
function addUser(user, cb) {
    ...
    if (list.hasOwnProperty(user.persona_state)) {
        ...
        switch (user.persona_state) {
            case 'ingame':  color = "green-fg";  break;
            case 'online':  color = "blue-fg";   break;
            case 'busy':    color = "red-fg";    break;
            case 'away':    color = "yellow-fg"; break;
            case 'snooze':  color = "white-fg";  break;
            case 'offline': color = "grey-fg";   break;
        }
